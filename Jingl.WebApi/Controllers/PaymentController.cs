    ...
    public class PaymentController : Controller
    {
      ...
      //  private readonly ICookie _cookie;
        ...
        public PaymentController(IConfiguration config)
        {
            ...
            this.BookingController = new BookingController(config);
        ...
        public ActionResult PaymentNotification([FromBody] TransactionResultModel body)
        {
            ...
            catch (Exception ex)
            {
                ...
                HelperController.InsertLog(Convert.ToInt32(0), "PaymentNotification", ex.Message);
        ...
        public async Task<IActionResult> PayFasPay([FromBody]BookModel model)
        {
            ...
            try
            {
                ...
                if (getcurrentdata.BookedBy == model.UserId)
                {
                    ...
                    HelperController.NotificationEmail(getcurrentdata.Email, getcurrentdata.Status.ToString(), EmailTargetType.User, getcurrentdata.Id, getcurrentdata.OrderNo, firstname).Wait();
                    return Json(new { Status = StatusCodes.Status200OK, Message = "OK", result = response });

                }

                else
                {
                    return Json(new { Status = StatusCodes.Status400BadRequest, Message = "User Tidak Memiliki Akses", result = response });
                }
            ...
            catch (Exception ex)
            {
                ...
                return Json(new { Status = StatusCodes.Status400BadRequest, Message = "OK", result = response });
            }

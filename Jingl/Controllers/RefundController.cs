...
namespace Jingl.Web.Controllers
{
    ...
    public class RefundController : Controller
    {
        ...
        public RefundController(IConfiguration config, ICookie cookie)
        {
                        ...
                        if (getBookData.BookedBy.Value.ToString() == rmodel.UserId)
                        {
                            ...
                            else
                            {
                                if(rmodel.BankCode == null  || rmodel.AccountNumber == null || rmodel.BeneficiaryName == null)
                                {
                                    ...
                                    {
                                        ClaimModel model = new ClaimModel();
                                        return Json(new { result = model, Status = "Error", Message = "Bank Code kosong" });
                                    }
                                    else if(rmodel.AccountNumber == null)
                                    {
                                        ClaimModel model = new ClaimModel();
                                        return Json(new { result = model, Status = "Error", Message = "Account Number kosong" });
                                    }
                                    else if(rmodel.BeneficiaryName == null)
                                    {
                                        ClaimModel model = new ClaimModel();
                                        return Json(new { result = model, Status = "Error", Message = "BeneficiaryName kosong" });
                                    }
                                ...
                                else
                                {
                                    ...
                                    {
                                        ClaimModel model = new ClaimModel();
                                        return Json(new { result = model, Status = "Error", Message = "Bank Code yang dimasukkan tidak tersedia" });
                                    }
                                    else
                                    {
                                        UserModel userModel = new UserModel();
                                        ...
                                        return Json(new { result = getClaim, Status = "OK", Message = "OK" });
                                    }
                            ...
                            return Json(new { result = models, Status = "Error", Message = " Data yang dimasukkan salah" });
                        }
                        else
                        {
                            ClaimModel model = new ClaimModel();
